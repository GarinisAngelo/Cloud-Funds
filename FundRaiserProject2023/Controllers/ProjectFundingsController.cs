    ...
    public class ProjectFundingsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProjectFundings != null ? 
                          View(await _context.ProjectFundings.Include("Backer").Include("Projects").ToListAsync()) :
        ...
        public async Task<IActionResult> Create(ProjectFunding projectFunding)
        {
            if (ModelState.IsValid)
            {
                projectFunding.Date = DateTime.Now;
